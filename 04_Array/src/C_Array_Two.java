...
public class C_Array_Two {
	 ...
	 * 2차원 배열은 할당된 공간마다 인덱스 번호를 두 개 부여한다.(앞번호는 몇 번째 1차원 배열인지, 뒷번호는 1차원 배열의 몇 번째 index인지를 구분)
	 */
	
	public static void main(String[] args) {
		
		/*
		 * 1. 2차원 배열 선언 (1차원 배열의 묶음을 참조하는 2차원 배열 참조 변수를 만들겠다.)
		 * 		자료형 배열명[][];
		 * 		자료형[][] 배열명; => 보통 이 방법을 선호
		 */
...
//		
//		int[][] tmp = new int[5][5]; // 5 크기의 1차원 배열 5개를 가진 2차원 배열 생성
//		
//		/*
//		 * 3. 값 대입
//		 * 		배열명[배열순번][인덱스] = 값;
